...
<%@page import="CV.service.SourceService"%>
...
<tr>
	<td align="right"><%=attachment.getAttachment_name()%>
		...
		<image border="0" width="200" height="100" src="<%=request.getContextPath()%>/<%=attachment.getAttachment_addr()%>">
		</a>
	</td>
</tr>	
<%
